...
#					if count != l[1]:
						...
						for n in range(len(l[0])):
							if l[0][n] in subs_elems_L and l[0][n] != l[0][count]:
								others.append(n)
						others.append(l[1])
	...
	for element in tries:
		...
		for n in element[1]:
			...
			swaps.append((element[0][n], n))
	print("Then the factorial of three is completed")
	print(swaps)
	print("Length of lists: {}".format(len(tries)))
	print("Length of other lists: {}".format(len(lists)))
	#Should be 7 x 6!, see how I go
